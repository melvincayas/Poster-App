...
router.route('/show/:postId/:commentId')
...
router.get('/show/:postId/:commentId/edit', validateLoggedIn, isCommentOwner, comments.editCommentForm);

router.route('/show/:postId/:commentId/:replyId')
    .put(validateLoggedIn, isReplyOwner, replies.editReply)
    .delete(validateLoggedIn, isReplyOwner, replies.deleteReply);

router.get('/show/:postId/:commentId/:replyId/edit', validateLoggedIn, isReplyOwner, replies.editReplyForm);
